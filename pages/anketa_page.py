...
class AnketaPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.complex_of_works_radio_button = WebElement(driver, 'div:nth-child(2) > div.sc-60972c5f-6.iVzsq > label:nth-child(1)')
        self.sait_radio_button = WebElement(driver, 'div:nth-child(2) > div.sc-60972c5f-6.iVzsq > label:nth-child(2)')
        self.service_radio_button = WebElement(driver, 'div:nth-child(2) > div.sc-60972c5f-6.iVzsq > label:nth-child(3)')
        self.design_radio_button = WebElement(driver, 'div:nth-child(2) > div.sc-60972c5f-6.iVzsq > label:nth-child(4)')
        self.ux_audit_radio_button = WebElement(driver, 'div:nth-child(2) > div.sc-60972c5f-6.iVzsq > label:nth-child(5)')
        self.branding_radio_button = WebElement(driver, 'div:nth-child(2) > div.sc-60972c5f-6.iVzsq > label:nth-child(6)')
